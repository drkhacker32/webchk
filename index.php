  ...
  <style> 
		...
		.btn-bg-gradient {
		  ...
		  .hr-statusbar{
			border:none;
			height:1px;
			background-image: linear-gradient(to right, #007fa9 , #25289e);
		  }
		  .footer-C {
			color:white;
			text-align: center;
	...
	<!-- Header IMG : https://i.ibb.co/Lrm15dD/Exceed-Logo-white.png -->
	<img href="https://i.ibb.co/Lrm15dD/Exceed-Logo-white.png" src="https://i.ibb.co/Lrm15dD/Exceed-Logo-white.png" alt="Exceed-Logo-white" border="0" style="
  display: block;
  margin-left: auto;
  margin-right: auto;
  width: 31px;
		...
		<div class="col-md-8">
			<div class="card" style="background-color:transparent;">
				<div class="card-body text-center" style="">
					...
					<textarea rows="8" class="form-control text-center form-checker mb-2" placeholder="XXXXXXXXXXXXXXXX|XX|XX|XXX" style="color:#ffffff94"></textarea>
...
<h5>LIVE :<span class="badge badge-success float-right aprovadas">0</span></h5><hr class="hr-statusbar">
...
$('.btn-trash').click(function(){
	Swal.fire({title: 'REMOVE DIE CCs SUCCESS', icon: 'success', showConfirmButton: false, toast: true, position: 'top-end', timer: 3000});
$('#lista_reprovadas').text('');
});

$('.btn-copy1').click(function(){
	Swal.fire({title: 'COPY CHARGED CCs SUCCESS', icon: 'success', showConfirmButton: false, toast: true, position: 'top-end', timer: 3000});
...
$('.btn-copy').click(function(){
	Swal.fire({title: 'COPY LIVE CCs SUCCESS', icon: 'success', showConfirmButton: false, toast: true, position: 'top-end', timer: 3000});
